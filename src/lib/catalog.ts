...
export const CATALOG: Product[] = [
  { sku: "HB-98-TI",  name: "HyperBurr 98 Titan",       category: "Burrovi",          price: 89_900,  image: g1,  stock: 8,
    blurb: "Ravan 98 mm burr sa TiN premazom, geometrija promenljivog koraka." },
  { sku: "HB-83-K",   name: "HyperBurr 83 Konični",     category: "Burrovi",          price: 74_900,  image: g2,  stock: 12,
    blurb: "Konični 83 mm, Rockwell 64 HRC. Idealan za espresso laboratorije." },
  { sku: "RS-LAB-01", name: "RoastSee Lab Analizator",  category: "Analizatori",      price: 489_000, image: g3,  stock: 3,
    blurb: "Stoni multispektralni analizator za pržionice — SONY IMX-500." },
  { sku: "P1-FLG",    name: "SOU SIK P-1 Flagship",     category: "Mlinske stanice",  price: 1_290_000, image: g4, stock: 1,
    blurb: "Monolitna stanica iz 7075-T6 aluminijuma. Ograničena serija." },
  { sku: "P1-LITE",   name: "SOU SIK P-1 Lite",         category: "Mlinske stanice",  price: 690_000, image: g5,  stock: 4,
    blurb: "Lite varijanta laboratorijske stanice za manje pogone." },
  { sku: "DOSER-PRO", name: "Doser Pro Inox",           category: "Pribor",           price: 24_900,  image: g6,  stock: 30,
    blurb: "Precizni dozator od nerđajućeg čelika, 58 mm korpa." },
  { sku: "TAMP-58",   name: "Tamper 58.5 Aluminijum",   category: "Pribor",           price: 12_900,  image: g7,  stock: 50,
    blurb: "CNC obrađen tamper, 58.5 mm, ergonomski izbalansiran." },
  { sku: "WDT-LAB",   name: "WDT Distribucioni alat",   category: "Pribor",           price: 8_900,   image: g8,  stock: 80,
    blurb: "Wedge Distribution Tool, 0.3 mm iglice od medicinskog inoxa." },
  { sku: "SHARP-SVC", name: "Servis oštrenja burrova",  category: "Servis",           price: 14_900,  image: g9,  stock: 999,
    blurb: "CNC oštrenje vašeg postojećeg burra do tvorničke geometrije." },
  { sku: "CAL-RS",    name: "RoastSee kalibracioni set",category: "Pribor",           price: 19_900,  image: g10, stock: 25,
