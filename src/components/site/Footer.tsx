    ...
    <footer className="py-16 sm:py-24 bg-background border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
        ...
        <div className="col-span-12 md:col-span-7 lg:col-span-6 space-y-6">
          <Link to="/" className="font-display font-bold tracking-tight text-lg sm:text-xl block text-card-foreground uppercase">
        ...
        <div className="col-span-12 md:col-span-5 lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-8 font-display font-medium text-[10px] uppercase tracking-widest">
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 text-muted-foreground">
              ...
              <Link to="/services" className="hover:text-foreground transition-colors">Usluge</Link>
              <Link to="/o-nama" className="hover:text-foreground transition-colors">O nama</Link>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 text-muted-foreground">
              <Link to="/contact" className="hover:text-foreground transition-colors">Kontaktirajte nas</Link>
              <a href="tel:+381648222651" className="hover:text-foreground transition-colors">064 8222 651</a>
              <a href="mailto:office@eop.rs" className="hover:text-foreground transition-colors">office@eop.rs</a>
            </div>
          </div>
        </div>
      </div>
